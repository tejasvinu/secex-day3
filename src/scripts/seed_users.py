...
sample_users = [
  ...
  { 'name': 'Team D003 User', 'email': 'teamd003user@cdac.in', 'role': 'participant', 'handle': 'teamm003user', 'password': 'D00345a2!#' },
  ...
  # Admin Users
  { 'name': 'Admin One', 'email': 'admin1@cdac.in', 'role': 'admin', 'handle': 'admin1', 'password': 'AdminPassword1!#' }, # Will get auto ID
  { 'name': 'Admin Two', 'email': 'admin2@cdac.in', 'role': 'admin', 'handle': 'admin2', 'password': 'AdminPassword2!#' }, # Will get auto ID
]
...
hardcoded_oids = [
    ...
    "68038d30016d47bb63ab467b", # Skip teamb010user
    ...
    "68038d30016d47bb63ab4658", "68038d30016d47bb63ab465d", # Skip teamd010user
    ...
    "68038d30016d47bb63ab467e", "68038d30016d47bb63ab4676", # Skip teamm012user
    "68038d30016d47bb63ab4662", "68038d30016d47bb63ab4660", "68038d30016d47bb63ab467f",
    "68038d30016d47bb63ab466a", "68038d30016d47bb63ab467c", "68038d30016d47bb63ab4673",
    ...
    for user_data in sample_users:
        ...
        if user_handle not in excluded_handles and oid_index < len(hardcoded_oids):
            ...
            if user_handle in excluded_handles:
                print(f"   Skipping hardcoded ID assignment for excluded user: {user_handle}")
            elif oid_index >= len(hardcoded_oids):
